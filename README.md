# CrAmki
Cramki is a tool that helps me convert my reviewers into flashcard faster because im lazy and got no time 
...
Am using fastApi for this as well and a few py libs
